  ...
  return (
    ...
    `<div style="padding:36px 32px;">
      ...
      <div style="background:#f0fbfc;border-radius:12px;padding:16px 20px;margin-bottom:28px;border:1px solid #c8eff4;">
        ...
        <p style="margin:6px 0 0;color:#555;font-size:13px;">Retiro en tienda · ${pickupAddress}</p>
        ${shipping === 'pickup' ? '<p style="margin:6px 0 0;color:#555;font-size:13px;">Aguardá nuestro contacto para pasar por el Showroom a retirar.</p>' : ''}
      </div>
      <p style="margin:0;color:#0eb1c3;font-weight:900;">Equipo Artentino</p>
    </div>` +
    emailFooter() +
