        ...
        {showArrows && (
          <>
            <button
              ...
              className="absolute left-3 top-1/2 -translate-y-1/2 flex h-11 w-11 items-center justify-center rounded-full bg-white/80 shadow-sm backdrop-blur-sm transition-opacity duration-200 hover:bg-white lg:h-9 lg:w-9"
            >
            ...
            <button
              ...
              onClick={() => goToIdx(activeIdx + 1)}
              className="absolute right-3 top-1/2 -translate-y-1/2 flex h-11 w-11 items-center justify-center rounded-full bg-white/80 shadow-sm backdrop-blur-sm transition-opacity duration-200 hover:bg-white lg:h-9 lg:w-9"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#1E1E1E" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
